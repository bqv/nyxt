...
(define-ffi-method ffi-window-set-status-buffer-height (window height))
(define-ffi-method ffi-window-set-message-buffer-height (window height))
(define-ffi-method ffi-window-get-status-buffer-height (window))
(define-ffi-method ffi-window-get-message-buffer-height (window))
...
(define-ffi-method ffi-buffer-evaluate-javascript-async (buffer javascript))
